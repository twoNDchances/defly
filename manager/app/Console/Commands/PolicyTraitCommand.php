...
#[Signature('custom:trait:policy {name : Trait name} {--force : Overwrite existing file}')]
#[Description('Create a trait file in app/Traits/Policies.')]
class PolicyTraitCommand extends Command
{
    use GeneratesFiles;
    ...
    public function handle(): int
    {
        ...
        $path = app_path("Traits/Policies/{$name}.php");
