...
#[Signature('custom:trait:observer {name : Trait name} {--force : Overwrite existing file}')]
#[Description('Create a trait file in app/Traits/Observers.')]
class ObserverTraitCommand extends Command
{
    use GeneratesFiles;
    ...
    public function handle(): int
    {
        ...
        $path = app_path("Traits/Observers/{$name}.php");
