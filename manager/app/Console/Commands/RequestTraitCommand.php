...
#[Signature('custom:trait:request {name : Trait name} {--force : Overwrite existing file}')]
#[Description('Create a trait file in app/Traits/Requests.')]
class RequestTraitCommand extends Command
{
    use GeneratesFiles;
    ...
    public function handle(): int
    {
        ...
        $path = app_path("Traits/Requests/{$name}.php");
