...
func (dq *DecisionQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (dq *DecisionQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (dq *DecisionQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (dq *DecisionQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (dq *DecisionQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (dq *DecisionQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := dq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (dq *DecisionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(decision.Table, decision.Columns, sqlgraph.NewFieldSpec(decision.FieldID, field.TypeUUID))
	_spec.From = dq.sql
