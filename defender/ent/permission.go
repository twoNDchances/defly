...
type Permission struct {
	...
	// AppliedFor holds the value of the "applied_for" field.
	...
	for i := range columns {
		...
		case permission.FieldAppliedFor:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field applied_for", values[i])
			} else if value.Valid {
				pe.AppliedFor = value.String
			}
...
func (pe *Permission) String() string {
	...
	builder.WriteString("applied_for=")
	builder.WriteString(pe.AppliedFor)
	builder.WriteString(", ")
