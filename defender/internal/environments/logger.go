...
var (
	...
	// ServerLoggerTimezone = ferrite.Enum("SERVER_LOGGER_TIMEZONE", "Timezone displayed in logging").
	// 			WithMembers(timezones...).
	// 			WithDefault("Asia/Ho_Chi_Minh").
	// 			Required()

	ServerLoggerTimezone = ferrite.String("SERVER_LOGGER_TIMEZONE", "Timezone displayed in logging").
				WithDefault("Asia/Ho_Chi_Minh").
				Required()
