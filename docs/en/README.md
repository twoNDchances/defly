...
Defly separates policy management, internal tasks, and traffic enforcement across Manager, Orchestrator, and Defender. Start with the path that matches your task; each subject has one authoritative page.
...
| Internal Docker and AI tasks | [Orchestrator Guide](Orchestrator-Guide.md) |
...
Pages outside their responsibility provide only enough context to follow the workflow and link back to the authoritative document instead of duplicating its tables or rules.
