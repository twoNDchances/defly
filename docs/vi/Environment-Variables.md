...
| `ORCHESTRATOR_PATH_ASSISTANT` | `assistant` | Đường dẫn trợ lý AI; được truyền thành `SERVER_PATH_ASSISTANT`. |
...
| `ORCHESTRATOR_METHOD_ASSISTANT` | `get` | Phương thức gọi trợ lý AI. |
...
### Nhà cung cấp AI trong Compose

| Biến | Mặc định | Ý nghĩa |
| --- | --- | --- |
| `AI_BASE_URL` | `https://api.openai.com/v1` | Địa chỉ API tương thích OpenAI mà Orchestrator gọi. |
| `AI_MODEL` | `gpt-4.1-mini` | Mô hình dùng cho trợ lý. |
| `AI_TIMEOUT` | `60` | Thời gian chờ phản hồi AI, tính bằng giây. |
| `AI_MAX_MESSAGES` | `40` | Số tin nhắn gần nhất được gửi cho model; `0` là không giới hạn. |
| `AI_MAX_MESSAGE_CHARACTERS` | `4000` | Số ký tự tối đa mỗi tin nhắn; `0` là không giới hạn. |
| `AI_API_KEY` | rỗng | Khóa API của nhà cung cấp AI; nếu rỗng, trợ lý trả lỗi chưa cấu hình. |
...
| `SERVER_PATH_ASSISTANT` | `assistant` | Đường dẫn trợ lý AI với cùng quy tắc như tiền tố. |
...
| `SERVER_METHOD_ASSISTANT` | `get` | Phương thức gọi trợ lý AI. |
...
| `AI_BASE_URL` | `https://api.openai.com/v1` | Địa chỉ API tương thích OpenAI mà Orchestrator gọi. |
| `AI_MODEL` | `gpt-4.1-mini` | Mô hình dùng cho trợ lý. |
| `AI_TIMEOUT` | `90.0` | Thời gian chờ phản hồi AI, tính bằng giây. |
| `AI_MAX_MESSAGES` | `40` | Số tin nhắn gần nhất được gửi cho model; `0` là không giới hạn. |
| `AI_MAX_MESSAGE_CHARACTERS` | `4000` | Số ký tự tối đa mỗi tin nhắn; `0` là không giới hạn. |
| `AI_API_KEY` | rỗng | Khóa API của nhà cung cấp AI; nếu rỗng, trợ lý trả `503`. |
...
| `ORCHESTRATOR_PATH_ASSISTANT` | `SERVER_PATH_ASSISTANT` | Đường dẫn trợ lý AI. |
| `ORCHESTRATOR_METHOD_*` | `SERVER_METHOD_*` | Phương thức của triển khai và trợ lý AI. |
