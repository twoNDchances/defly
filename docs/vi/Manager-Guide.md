...
Dùng Guard khi một Defender cần nhóm người vận hành nhỏ hơn nhóm đang có Permission chung cho Defender.
...
4. Gắn Guard nếu chỉ User cụ thể được phép thao tác trên Defender này.
5. Áp dụng Principle đã có trạng thái `passed`.
6. Cài Decision đúng hướng.
7. Lưu rồi chạy triển khai.
