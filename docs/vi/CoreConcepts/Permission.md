...
Permission `Defender:all` bao phủ các hành động của Defender, nhưng vẫn không bỏ qua ràng buộc trạng thái triển khai.
...
- Không nhầm Permission với quyền sở hữu, trạng thái khóa hoặc trạng thái quy trình.
